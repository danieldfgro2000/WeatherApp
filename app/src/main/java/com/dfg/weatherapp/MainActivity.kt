...
import com.dfg.weatherapp.models.WeatherResponse
import com.dfg.weatherapp.network.WeatherService
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRationalDialogForPermission() {
        AlertDialog.Builder(this)
            .setMessage("It looks like you have turned of permissions")
            .setPositiveButton(
                "GO TO SETTINGS"
            ) { _, _ ->
                try {
    ...
    private fun setupUI(){
        ...
        if(!weatherResponseJsonString.isNullOrEmpty()){
            ...
            for (i in weatherList.weather.indices){
                ...
                tv_speed.text = ((weatherList.wind.speed * 1.6).toInt().toShort()).toString()
